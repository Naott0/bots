...
AUDIO_WIN1 = os.path.expanduser(
    '/home/support/TelegramBot/Project/Bots/audio/GTA_Vice_City/OST/GTA_Vice_City_OST_part_1.mp3')
AUDIO_WIN2 = os.path.expanduser(
    '/home/support/TelegramBot/Project/Bots/audio/GTA_Vice_City/OST/GTA_Vice_City_OST_part_2.mp3')
AUDIO_WIN3 = os.path.expanduser(
    '/home/support/TelegramBot/Project/Bots/audio/GTA_Vice_City/OST/GTA_Vice_City_OST_part_3.mp3')
AUDIO_WIN4 = os.path.expanduser(
    '/home/support/TelegramBot/Project/Bots/audio/GTA_Vice_City/OST/GTA_Vice_City_OST_part_4.mp3')
AUDIO_EMOTION1 = os.path.expanduser(
    '/home/support/TelegramBot/Project/Bots/audio/GTA_Vice_City/Emotion/Emotion_98_part_1.mp3')
AUDIO_EMOTION2 = os.path.expanduser(
    '/home/support/TelegramBot/Project/Bots/audio/GTA_Vice_City/Emotion/Emotion_98_part_2.mp3')
AUDIO_EMOTION3 = os.path.expanduser(
    '/home/support/TelegramBot/Project/Bots/audio/GTA_Vice_City/Emotion/Emotion_98_part_3.mp3')

AUDIO_FEVER1 = os.path.expanduser(
    '/home/support/TelegramBot/Project/Bots/audio/GTA_Vice_City/Fever 105/GTA_Vice_City_OST_-_Fever_105_part_1.mp3')

AUDIO_FEVER2 = os.path.expanduser(
    '/home/support/TelegramBot/Project/Bots/audio/GTA_Vice_City/Fever 105/GTA_Vice_City_OST_-_Fever_105_part_2.mp3')
AUDIO_FEVER3 = os.path.expanduser(
    '/home/support/TelegramBot/Project/Bots/audio/GTA_Vice_City/Fever 105/GTA_Vice_City_OST_-_Fever_105_part_3.mp3')

AUDIO_FEVER4 = os.path.expanduser(
    '/home/support/TelegramBot/Project/Bots/audio/GTA_Vice_City/Fever 105/GTA_Vice_City_OST_-_Fever_105_part_4.mp3')

AUDIO_ESPANTO1 = os.path.expanduser(
    '/home/support/TelegramBot/Project/Bots/audio/GTA_Vice_City/Espantoso/GTA_Vice_City_OST_-_Radio_Espantoso_part_1.mp3')
AUDIO_ESPANTO2 = os.path.expanduser(
    '/home/support/TelegramBot/Project/Bots/audio/GTA_Vice_City/Espantoso/GTA_Vice_City_OST_-_Radio_Espantoso_part_2.mp3')
AUDIO_ESPANTO3 = os.path.expanduser(
    '/home/support/TelegramBot/Project/Bots/audio/GTA_Vice_City/Espantoso/GTA_Vice_City_OST_-_Radio_Espantoso_part_3.mp3')
AUDIO_ESPANTO4 = os.path.expanduser(
    '/home/support/TelegramBot/Project/Bots/audio/GTA_Vice_City/Espantoso/GTA_Vice_City_OST_-_Radio_Espantoso_part_4.mp3')
...
async def process_wildstyle_command(message: types.Message):
    audio1 = types.InputFile(AUDIO_WIN1)
    audio2 = types.InputFile(AUDIO_WIN2)
    audio3 = types.InputFile(AUDIO_WIN3)
    audio4 = types.InputFile(AUDIO_WIN4)
    OST = open('/home/support/TelegramBot/Project/Bots/audio/GTA_Vice_City/OST/front.jpg', 'rb')
    await message.answer_photo(OST)
    await message.answer_audio(audio1, performer='GTA vice city part 1', title='Wildstyle')
    await message.answer_audio(audio2, performer='GTA vice city part 2', title='Wildstyle')
    await message.answer_audio(audio3, performer='GTA vice city part 3', title='Wildstyle')
    await message.answer_audio(audio4, performer='GTA vice city part 4', title='Wildstyle')
async def process_emotion_command(message: types.Message):
    audio1 = types.InputFile(AUDIO_EMOTION1)
    audio2 = types.InputFile(AUDIO_EMOTION2)
    audio3 = types.InputFile(AUDIO_EMOTION3)
    EMO = open('/home/support/TelegramBot/Project/Bots/audio/GTA_Vice_City/Emotion/12.jpg', 'rb')
    await message.answer_photo(EMO)
    await message.answer_audio(audio1, performer='GTA vice city part 1', title='Emotion 98.3')
    await message.answer_audio(audio2, performer='GTA vice city part 2', title='Emotion 98.3')
    await message.answer_audio(audio3, performer='GTA vice city part 3', title='Emotion 98.3')
async def process_fever_command(message: types.Message):
    audio1 = types.InputFile(AUDIO_FEVER1)
    audio2 = types.InputFile(AUDIO_FEVER2)
    audio3 = types.InputFile(AUDIO_FEVER3)
    audio4 = types.InputFile(AUDIO_FEVER4)
    FEVER = open('/home/support/TelegramBot/Project/Bots/audio/GTA_Vice_City/Fever 105/1.jpg', 'rb')
    await message.answer_photo(FEVER)
    await message.answer_audio(audio1, performer='GTA vice city part 1', title='Fever 105')
    await message.answer_audio(audio2, performer='GTA vice city part 2', title='Fever 105')
    await message.answer_audio(audio3, performer='GTA vice city part 3', title='Fever 105')
    await message.answer_audio(audio4, performer='GTA vice city part 4', title='Fever 105')
async def process_espantoso_command(message: types.Message):
    audio1 = types.InputFile(AUDIO_ESPANTO1)
    audio2 = types.InputFile(AUDIO_ESPANTO2)
    audio3 = types.InputFile(AUDIO_ESPANTO3)
    audio4 = types.InputFile(AUDIO_ESPANTO4)
    ESPA = open('/home/support/TelegramBot/Project/Bots/audio/GTA_Vice_City/Espantoso/1.jpg', 'rb')
    await message.answer_photo(ESPA)
    await message.answer_audio(audio1, performer='GTA vice city part 1', title='Espantoso')
    await message.answer_audio(audio2, performer='GTA vice city part 2', title='Espantoso')
    await message.answer_audio(audio3, performer='GTA vice city part 3', title='Espantoso')
    await message.answer_audio(audio4, performer='GTA vice city part 4', title='Espantoso')
